...
public class ProductAddonTranslationContaine : IProductAddonTranslationContainer
{
    private readonly IProductAddonTranslationRepository _repository;

    public ProductAddonTranslationContaine(IProductAddonTranslationRepository repository)
    {
